...
# MODEL
pneumonia_model = load_model(r'PNEUMONIA\Model\Pneumonia.h5')
...
tuberculosis_model = load_model(r'TUBERCULOSIS\Model\Tuberculosis-1.h5')
brain_tumor_model = load_model(r'BRAIN TUMOR\Model\model.h5')
image_gen = ImageDataGenerator(
    preprocessing_function=tf.keras.applications.mobilenet_v2.preprocess_input)
with open(r'DIABETES\Model\diabetesPredictionModel.pkl', 'rb') as file:
