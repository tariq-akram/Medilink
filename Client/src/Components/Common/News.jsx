...
export function News() {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                const response = await axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=2cdd431d20174762be5a637373549151&page=${page}&pageSize=${cardsPerPage}`);
