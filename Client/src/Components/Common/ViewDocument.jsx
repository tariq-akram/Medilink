                ...
                <div className="lg:-mt-18">
                    <div className="p-3 lg:p-0 ">
                        ...
                        <p className="select-none text-neutral-500 max-w-lg mx-auto text-lg lg:text-[1.25rem] tracking-[1px] font-ai p-3 lg:p-0 text-justify">
                            Welcome to  Medilink, your secure and easy-to-use platform for managing your vital medical documents. We prioritize your privacy and convenience, ensuring a seamless experience every time.
                        </p>
                    </div>
